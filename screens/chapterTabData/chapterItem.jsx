    ...
    return (
        <TouchableOpacity style={ {
            ...
            <View style={ {
                ...
                <Entypo name="eye-with-line" size={ 18 } color={ globalVars.varColorGray } />
            </View>
            <View style={ {
                display: 'flex',
                ...
                <View style={ {
                    ...
                    <View style={ {
                        ...
                        <FontAwesome style={ {
                            marginRight: 5
                        } } name="user-o" size={ 12 } color={ globalVars.varColorGray } />
                        <Text style={ {
                            fontFamily: globalVars.fontExo400,
                            fontSize: 13,
                            color: globalVars.varColorGray
            ...
            <TouchableOpacity style={ {
                ...
                <FontAwesome name="cloud-download" size={ 18 } color={ globalVars.varColorGray } />
            </TouchableOpacity>
        </TouchableOpacity>
    )
}
