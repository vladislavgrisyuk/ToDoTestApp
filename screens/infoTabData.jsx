...
const InfoTabData = ({ article, moveDetailsView }) =>
{
    ...
    return (
        <ScrollView
            bounces={ false }
            showsVerticalScrollIndicator={ false } style={ { backgroundColor: 'white' } } contentContainerStyle={ { flexGrow: 1, backgroundColor: 'white', paddingVertical: 8 } }>
            <View style={ {
